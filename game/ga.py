...
def is_empty_ceil(field: list, x: int, y: int):
...
def is_win(field: list, symbol: str) -> bool:
    ...
    for win_comb in win_combinations:
        ceil_1 = get_ceil(field, x=win_comb[0][0]-1, y=win_comb[0][1]-1)
        ceil_2 = get_ceil(field, x=win_comb[1][0]-1, y=win_comb[1][1]-1)
